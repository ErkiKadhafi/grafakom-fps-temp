...
function init() {
  ...
  // plane geometry
  {
    var floorTexture = THREE.ImageUtils.loadTexture("texture/grass1.jpg");
  ...
  {
    var floorTexture = THREE.ImageUtils.loadTexture("texture/water.jpg");
...
function animate() {
  ...
  if ((keyboard[32] || keyboard[13]) && player.canShoot <= 0) {
    ...
    // bullet speed
    bullet.velocity = new THREE.Vector3(-Math.sin(camera.rotation.y), 0, 0.5);
